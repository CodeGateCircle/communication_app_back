...
ActiveRecord::Schema[7.0].define(version: 20_230_425_080_427) do
  ...
  create_table "group_users", force: :cascade do |t|
    ...
    t.index ["workspace_id"], name: "index_group_users_on_workspace_id"
  end
  ...
  add_foreign_key "group_users", "workspaces"
